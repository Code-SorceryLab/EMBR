...
def _do_reckoning_reveal() -> None:
    ...
    from embr.cli.demos import demo_reckoning_reveal
...
def _do_mood_slider() -> None:
    ...
    from embr.cli.demos import demo_mood_slider
...
def _do_defence_dial() -> None:
    ...
    from embr.cli.demos import demo_defence_dial
...
def _do_tag_flip() -> None:
    ...
    from embr.cli.demos import demo_tag_flip
...
def _do_estimator_divergence() -> None:
    ...
    from embr.cli.demos import demo_estimator_divergence
...
def _do_record_walk() -> None:
    ...
    from embr.cli.demos import run_record
